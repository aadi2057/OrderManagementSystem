...
public void approvedOrder() throws FileNotFoundException, IOException
{
     ...
     */
    public OrderList() throws FileNotFoundException, IOException {
        initComponents();
...
// TODO add your handling code here:
    ...
    private void tblCustomerListMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblCustomerListMouseClicked
        // TODO add your handling code here:
        File f = new File("src/textFiles/approvedOrders.txt");
        if(!f.exists()){
            try {
        ...
        int res = JOptionPane.showConfirmDialog(this, "Do you want to accept the Order. \r\nIf yes press OK if no press NO.");
        if(res==0){
            try {File file = new File("src/textFiles/Order.txt");
                BufferedReader br = new BufferedReader(new FileReader(file));
                ...
                try (PrintWriter pw = new PrintWriter(bw)) {
                    ...
                    pw.println(model.getValueAt(selectedRow, 0) + ","+ model.getValueAt(selectedRow, 1)+ ","+ model.getValueAt(selectedRow, 2)+ ","+ model.getValueAt(selectedRow, 3)+ ","+ model.getValueAt(selectedRow, 4)+ ","+ model.getValueAt(selectedRow, 5)+ ","+ model.getValueAt(selectedRow, 6));
                    pw.flush();
                    pw.close();
//                    try (BufferedWriter bwo = new BufferedWriter(new FileWriter(file)); PrintWriter pwo = new PrintWriter(bwo)) {
//                    
//                    
//                    Object[] tableLines = br.lines().toArray();
//                    int i;
//                    System.out.println(Arrays.toString(tableLines));
//                    for(i=0; i<tableLines.length; i++){
//                        String lines = tableLines[i].toString().trim();
//                        String[] tableRow = lines.split(",");
//                        if(tableRow[0].equals(model.getValueAt(selectedRow, 0)) && tableRow[2].equals(model.getValueAt(selectedRow, 2))){
//                            System.out.println("If block printed");
//                        }
//                        else{
