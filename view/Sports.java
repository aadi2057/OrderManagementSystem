...
public class Sports extends javax.swing.JFrame {
     ...
     */
    public Sports() throws FileNotFoundException, IOException {
        initComponents();
                ...
                for(i=0; i<tableLines.length;i++){
                    ...
                    try{
                        ...
                        if(prodname.equals(tableRow[1]) && stockQuantity > 0){
                            ...
                            pw.println(rowData[0]+","+ rowData[1] + ","+ prodname + "," +"Sports,"+ quantity +","+ rate*quantity+","+ dtf.format(now) );
