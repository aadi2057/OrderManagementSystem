 ...
 * @author User
 */
public class Kitchenwares extends javax.swing.JFrame {
    ...
    public void clothesList() throws FileNotFoundException, IOException{
       ...
       for(i=0; i<tableLines.length;i++){
           ...
           if("Kitchenware".equals(tableRow[4])){
     ...
     */
    public Kitchenwares() throws FileNotFoundException, IOException {
        initComponents();
                ...
                for(i=0; i<tableLines.length;i++){
                    ...
                    try{
                        ...
                        if(prodname.equals(tableRow[1]) && stockQuantity > 0){
                            ...
                            pw.println(rowData[0]+","+ rowData[1] + ","+ prodname + "," +"Kitchenware,"+ quantity +","+ rate*quantity+","+ dtf.format(now) );
...
//                System.out.println("Inside first loop");
            ...
            Logger.getLogger(Kitchenwares.class.getName()).log(Level.SEVERE, null, ex);
...
// TODO add your handling code here:
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Kitchenwares.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(() -> {
            try {
                new Kitchenwares().setVisible(true);
            } catch (FileNotFoundException ex) {
                Logger.getLogger(Kitchenwares.class.getName()).log(Level.SEVERE, null, ex);
            } catch (IOException ex) {
                Logger.getLogger(Kitchenwares.class.getName()).log(Level.SEVERE, null, ex);
